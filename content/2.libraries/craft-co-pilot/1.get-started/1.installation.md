...
If you encounter bugs or have feature requests, [please submit an issue](https://github.com/samuelreichor/craft-co-pilot/issues/new?template=bug-report.yaml) or use the `/bug-report` command in the chat window. 
