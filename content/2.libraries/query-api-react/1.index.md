...
icon: 'react'
seo:
  title: '@query-api/react the Craft CMS Query Builder for React'
  description: The @query-api/react library brings the craft query builder to your React frontend.
---
