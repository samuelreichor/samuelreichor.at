...
icon: 'next'
seo:
  title: '@query-api/next the Craft CMS Query Builder for Next.js'
  description: The @query-api/next library brings the craft query builder to your Next.js frontend.
---
