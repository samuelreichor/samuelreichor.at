...
| Field location | `object` is |
|---|---|
| Site Settings (LLM Title, LLM Description, LLM Note) | the current `Site` |
| Content Settings (Section Title, Section Description) | the `Section` or `ProductType` |
| Content Settings (Default Title, Default Description) | the rendered `Element` |
| LLMify Settings Field (LLM Title, LLM Description) | the rendered `Element` |
