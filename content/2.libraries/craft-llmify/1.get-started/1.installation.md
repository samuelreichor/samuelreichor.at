...
- `/{your-uri}.md`: Markdown for a single entry, `/index.md` for the homepage
...
### Add AI Bot Analytics (Optional)

Want to see which AI crawlers actually hit your Markdown, how often, and which pages they read? Install [Craft Insights](/libraries/craft-insights) alongside LLMify and a dedicated dashboard appears in the Insights subnav.
...
::alert{variant="note"}
The integration activates automatically when both plugins are installed. See the [AI Bot Analytics](/libraries/craft-llmify/usage/ai-bot-analytics) page for the full setup.
::
