...
icon: 'ts'
seo:
  title: '@query-api/js a Craft CMS query builder for JavaScript'
  description: '@query-api/js is the foundation to build a query builder for Craft CMS with your preferred JavaScript framework.'
---
