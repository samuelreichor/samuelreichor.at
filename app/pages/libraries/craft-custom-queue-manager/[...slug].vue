<script setup lang="ts">
  ...
  const { page, navNodes, headline } = await useCustomNavs('/libraries/craft-custom-queue-manager')
...
<template>
  <NuxtLayout name="sidebar">
    <template v-slot:sidebarleft>
      <SidebarLeft :nodes="nodeProps" pre-selected-value="craft-custom-queue-manager" />
    </template>

    <template v-slot:main>
      <HeroSimple :headline="page?.title ?? 'Not Implemented'" :label="headline" :description="page?.description" :badge="page?.badge" />
